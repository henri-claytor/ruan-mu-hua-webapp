# cross-page-trade-summary Specification

## Purpose

在個股分析頁底部顯示使用者在該股票的「實際交易紀錄摘要」，並做「市場長期月賠率 vs 我的交易賠率」對照——這是前向（市場資料）與後向（交易紀錄）兩個功能整合後才能產出的獨家洞察。
...
#### Scenario: 市場資料不足
- **WHEN** marketPayoff 為 null（evMulti 為 null，月報酬 < 60 筆）
